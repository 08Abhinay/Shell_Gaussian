...
SHOE=$1
GPU=$2
CONFIG=${3:-confs/udf_shoes_open_ft.conf}
RESOLUTION=${4:-512}
SEED=${NEURALUDF_SEED:-0}
THRESHOLD=${NEURALUDF_THRESHOLD:-0.005}
CHECKPOINT=${NEURALUDF_INIT_CHECKPOINT:-$ROOT/output/open_surface_full/$SHOE/udf_open/checkpoints/ckpt_300000.pth}
...
[[ -s $CHECKPOINT ]] || { echo "Initial 300k checkpoint is missing: $CHECKPOINT" >&2; exit 1; }
